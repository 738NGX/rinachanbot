...
const birthdays = [
  ...
  { month: 2, date: 13, name: '麻布麻衣', role: '角色', group: '人生不易部！' },
  ...
  { month: 3, date: 2, name: '金泽奇迹', role: '角色', group: '人生不易部！' },
  ...
  { month: 4, date: 20, name: '进藤天音', role: '声优', group: '莲之空女学院学园偶像俱乐部' },
  ...
  { month: 5, date: 7, name: '山田真绿', role: '角色', group: '人生不易部！' },
  ...
  { month: 6, date: 18, name: '凉之濑葵音', role: '声优', group: '人生不易部！' },
  { month: 6, date: 26, name: '塞拉斯柳田利林菲尔德', role: '角色', group: '莲之空女学院学园偶像俱乐部' },
  ...
  { month: 7, date: 9, name: '五桐玲', role: '角色', group: '人生不易部！' },
  ...
  { month: 8, date: 18, name: '高桥波尔卡', role: '角色', group: '人生不易部！' },
  ...
  { month: 11, date: 11, name: '佐佐木翔音', role: '角色', group: '人生不易部！' },
  ...
  { month: 12, date: 1, name: '桂城泉', role: '角色', group: '莲之空女学院学园偶像俱乐部' },
  ...
  { month: 12, date: 14, name: '奥村优季', role: '声优', group: '莲之空女学院学园偶像俱乐部' },
  ...
  { month: 12, date: 31, name: '绫咲穗音', role: '声优', group: '人生不易部！' }
];
...
export async function getBirthdaysByDateFromDb(month: number, date: number, ctx: Context) {
  const birthdaysByDate = await ctx.database.get('rina.birthday', { month: [month], date: [date] });
  if (birthdaysByDate.length === 0) return `今天没有饱饱过生日[╹▽╹]`;

  const formatBirthdays = (birthdays: any[]) => {
    return birthdays.map(b => h('at', { id: b.userid })).join('\n');
  }

  if (birthdaysByDate.length > 1) {
    return `今天是这些饱饱的生日,祝饱饱们生日快乐[≧▽≦]\n${formatBirthdays(birthdaysByDate)}`;
  } else {
    return `今天是${h('at', { id: birthdaysByDate[0].userid })}的生日,祝饱饱生日快乐[≧▽≦]`;
  }
}
